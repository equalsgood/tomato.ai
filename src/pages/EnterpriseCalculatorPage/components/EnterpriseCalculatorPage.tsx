...
const questions: Array<SingleFaq> = [
    {
        question: 'How to estimate the financial impact of a 1% CSAT or FCR lift?',
        answer: 'For an Enterprise to estimate the revenue impact per 1% lift in CSAT (Customer Satisfaction) or savings impact per 1% lift in FCR (First Call Resolution) consider these options:\n' +
            ...
            '(b) analyzing historical data for periods when you had higher average CSAT and FCR than the current average'
    },
    {
